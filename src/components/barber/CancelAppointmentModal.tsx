          ...
          <form onSubmit={handleSubmitCancel} id="cancel-appointment-form" className="space-y-4">
            ...
            {selectedReasonOption === 'Outro motivo personalizado' && (
              <div>
                ...
                <input
                  ...
                  className="w-full px-3.5 py-2.5 bg-white dark:bg-slate-800 border-2 border-slate-300 dark:border-slate-600 rounded-xl text-xs font-bold text-slate-900 dark:text-white placeholder:text-slate-400 focus:outline-hidden focus:ring-2 focus:ring-rose-500"
                />
              </div>
            )}
            ...
            {appointment.status === 'confirmed' && (
              <div>
                ...
                <input
                  ...
                  className="w-full px-3.5 py-2.5 bg-white dark:bg-slate-800 border-2 border-emerald-300 dark:border-emerald-700 rounded-xl text-xs font-bold text-slate-900 dark:text-white placeholder:text-slate-400 focus:outline-hidden focus:ring-2 focus:ring-emerald-500"
                />
              </div>
            )}
            ...
            <div>
              ...
              <textarea
                ...
                className="w-full p-3 bg-white dark:bg-slate-800 border-2 border-slate-300 dark:border-slate-600 rounded-xl text-xs font-bold text-slate-900 dark:text-white placeholder:text-slate-400 font-mono leading-relaxed focus:outline-hidden focus:ring-2 focus:ring-amber-500"
              />
            </div>
